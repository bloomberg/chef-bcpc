...
source ../shared/shared_functions
export REPO_ROOT=$REPO_ROOT

load_configs

# Perform preflight checks to validate environment sanity as much as possible.
echo -n "Performing preflight environment validation..."
source $REPO_ROOT/bootstrap/shared/shared_validate_env.sh && echo " done!" || exit 1

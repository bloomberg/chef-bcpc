...
from watcher.conf import nova_helper #This line is a custom change for Bloomberg
...
nova_helper.register_opts(CONF) #This line is a custom change for Bloomberg

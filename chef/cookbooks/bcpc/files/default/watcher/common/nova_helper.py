...
class NovaHelper(object):
    ...
    # Original lines commented below for reference, and are replaced by custom
    # code for Bloomberg below the commented lines
    #
    ...
    def watcher_non_live_migrate_instance(
        ...
        # The line below is custom code for Bloomberg
        ...
        if not instance:
            ...
            while (getattr(instance, 'status') not in
                ...
                instance = self.nova.servers.get(instance.id)
                # Original lines commented below for reference, and are
                # replaced by custom code for Bloomberg below the commented
                # lines
                #
                # time.sleep(2)
                # retry -= 1
